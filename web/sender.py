...
our_email = "xxxjamesfoil@gmail.com"
...
def gmail_authenticate():
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            flow = InstalledAppFlow.from_client_secrets_file("newtoke.json", SCOPES)
...
def build_message(destination, obj, body, attachments=None):
    if not attachments:  # no attachments given
        ...
        message["to"] = destination
        message["from"] = "hehh"  # not necessary. This will be read from the pickle
        message["subject"] = obj
